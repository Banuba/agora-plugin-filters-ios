...
2. Open the BanubaAgoraFilters.xcodeproj file in Xcode and delete all existing items from «General->Frameworks, Libraries, and Embedded Content» and from the Frameworks folder in the BanubaAgoraFilters project structure (the left part of Xcode window).
...
6. Download the Agora Video SDK from the Agora site (supported version is 3.6.201 or higher). Put the received `Agoraffmpeg.framework` and `AgoraRtcKit.framework` to “Frameworks, Libraries, and Embedded Content” section in your project.
